...
//VERSION_BEGIN 14.1 cbx_altfp_sqrt 2014:12:03:18:16:05:SJ cbx_cycloneii 2014:12:03:18:16:05:SJ cbx_lpm_add_sub 2014:12:03:18:16:05:SJ cbx_mgl 2014:12:03:20:51:57:SJ cbx_stratix 2014:12:03:18:16:05:SJ cbx_stratixii 2014:12:03:18:16:05:SJ  VERSION_END
...
module  fp_sqrt_alt_sqrt_block_rcb
	( 
	aclr,
	clken,
	clock,
...
endmodule //fp_sqrt_alt_sqrt_block_rcb

//synthesis_resources = lpm_add_sub 27 reg 1433 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_sqrt_altfp_sqrt_4jc
	( 
	clock,
	data,
	result) ;
	...
	fp_sqrt_alt_sqrt_block_rcb   alt_sqrt_block2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
...
endmodule //fp_sqrt_altfp_sqrt_4jc
//VALID FILE
...
module fp_sqrt (
	...
	fp_sqrt_altfp_sqrt_4jc	fp_sqrt_altfp_sqrt_4jc_component (
				.clock (clock),
				.data (data),
				.result (sub_wire0));
