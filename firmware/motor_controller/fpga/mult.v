...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" EXCEPTION_HANDLING="NO" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab nan overflow result underflow
...
module mult (
	...
	mult_altfp_mult_mrp	mult_altfp_mult_mrp_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.nan (sub_wire0),
