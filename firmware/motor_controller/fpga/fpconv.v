...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa nan result
...
endmodule //fpconv_altbarrel_shift_kof

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 282 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
endmodule //fpconv_altfp_convert_45n
//VALID FILE
...
module fpconv (
	...
	fpconv_altfp_convert_45n	fpconv_altfp_convert_45n_component (
				.clock (clock),
				.dataa (dataa),
				.nan (sub_wire0),
				.result (sub_wire1));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fpconv.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpconv.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpconv.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpconv_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpconv_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpconv.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpconv.cmp TRUE TRUE
