...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=16 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=16 clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=38 WIDTHDIST=6 aclr clk_en clock data distance result
...
endmodule //float32_int16_altbarrel_shift_mof

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 217 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  float32_int16_altfp_convert_bqm
	( 
	clock,
	dataa,
	result) ;
	...
	float32_int16_altbarrel_shift_mof   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //float32_int16_altfp_convert_bqm
//VALID FILE
...
module float32_int16 (
	...
	float32_int16_altfp_convert_bqm	float32_int16_altfp_convert_bqm_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL float32_int16.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL float32_int16.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL float32_int16.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL float32_int16_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL float32_int16_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL float32_int16.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL float32_int16.cmp FALSE TRUE
