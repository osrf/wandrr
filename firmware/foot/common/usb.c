...
void usb_init()
{
  ...
  g_usb_device_descriptor[8] = 0x55; // vid lsb
  g_usb_device_descriptor[9] = 0xf0; // vid msb
  g_usb_device_descriptor[10] = 0x26; // pid lsb
  g_usb_device_descriptor[11] = 0x01; // pid msb
