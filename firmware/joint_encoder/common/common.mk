...
TC=arm-none-eabi-
ROOT=../..
OPENOCD=openocd -f $(ROOT)/common/stm32/olimex-arm-usb-tiny-h.cfg -f $(ROOT)/common/stm32/stm32f411.cfg -f ../common/wandrr_jenc.cfg
COMMON_SRCS=startup stubs led pin console systime delay usb enc parity
