...
TC=arm-none-eabi-
ROOT=../..
OPENOCD=openocd -f $(ROOT)/common/stm32/olimex-arm-usb-tiny-h.cfg -f $(ROOT)/common/stm32/stm32f427.cfg -f ../common/power_router.cfg
COMMON_SRCS=startup stubs led pin console delay systime relays discharge remote power enet state adc battery
COMMON_OBJS=$(COMMON_SRCS:%=$(BIN)/%.o)
OBJS=$(SRCS:%.c=$(BIN)/%.o)
LDSCRIPT ?= app
IMAGE_START ?= 0x08020000

CFLAGS=-g $(HARD_FLOAT_FLAGS) -mthumb -mcpu=cortex-m4 -ffunction-sections -fdata-sections -MD -std=gnu99 -Wall -I$(ROOT)/common/stm32 -DHSE_VALUE=25000000 -Werror -I. -I../common
